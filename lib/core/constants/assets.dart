class AssetsImages {
  ...
  static const String failureSVG = "${assetsPath}failure_loading_image.svg";
  static const String countrySVG = "${assetsPath}country.svg";
  static const String companySVG = "${assetsPath}company.svg";
  static const String stateSVG = "${assetsPath}state.svg";
